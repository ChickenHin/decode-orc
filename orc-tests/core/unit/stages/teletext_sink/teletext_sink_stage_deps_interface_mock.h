/*
 * File:        teletext_sink_stage_deps_interface_mock.h
...
#ifndef DECODE_ORC_ROOT_TELETEXT_SINK_STAGE_DEPS_INTERFACE_MOCK_H
#define DECODE_ORC_ROOT_TELETEXT_SINK_STAGE_DEPS_INTERFACE_MOCK_H
...
class MockTeletextSinkStageDeps : public orc::ITeletextSinkStageDeps {
 public:
  ...
  MOCK_METHOD(orc::TeletextSinkResult, export_t42,
...
#endif  // DECODE_ORC_ROOT_TELETEXT_SINK_STAGE_DEPS_INTERFACE_MOCK_H
