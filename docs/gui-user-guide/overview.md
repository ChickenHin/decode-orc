...
**Sink stages** consume data and produce final outputs targeted to the associated ld-decode/vhs-decode project tools, or to external tools such as the Daphne arcade LaserDisc emulator.
